...
const DotGroup = ({selectedPage, setSelectedPage}) => {
  ...
  return (
    ...
    />
     <AnchorLink className = {`${selectedPage === "projects" ? selectedStyle : "bg-dark-grey"} w-3 h-3 rounded-full`}
    href = "#projects"
    onClick = {()=> setSelectedPage('projects')}
    />
     <AnchorLink className = {`${selectedPage === "testimonials" ? selectedStyle : "bg-dark-grey"} w-3 h-3 rounded-full`}
    href = "#testimonials"
